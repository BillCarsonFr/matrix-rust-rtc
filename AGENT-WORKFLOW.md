...
> Keep runtime instructions inlined in `AGENTS.md` so agents can read them in one pass.
...
Before committing any code change, run the project's standard validation suite (defined in `AGENTS.md`) and resolve all errors.
